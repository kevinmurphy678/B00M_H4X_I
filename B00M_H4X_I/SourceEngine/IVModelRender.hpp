...
namespace SourceEngine {
	...
	typedef struct StudioDecalHandle_t* test;
	...
	{
	public:
		inline void ForcedMaterialOverride(IMaterial *mat)
		{
			typedef void(__thiscall *oForcedMaterialOverride)(void*, IMaterial*, int, int);
			CallVFunction<oForcedMaterialOverride>(this, 1)(this, mat, 0, 0);
		}

		inline void DrawModelExecute(void* ctx, void *state, const ModelRenderInfo_t &pInfo, matrix3x4_t *pCustomBoneToWorld = NULL)
		{
			typedef void(__thiscall *oDrawModelExecute)(void*, void* ctx, void *state, const ModelRenderInfo_t &pInfo, matrix3x4_t *pCustomBoneToWorld);
			CallVFunction<oDrawModelExecute>(this, 21)(this, ctx, state, pInfo, pCustomBoneToWorld);
		}
	};
}